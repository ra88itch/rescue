		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="content">
						<div class="row">								
							<form method="GET" action="<?php echo $root; ?>teamAccount/lists">
								<div class="col-md-6">
								...
								<div class="col-md-3">
									<button type="button" class="btn btn-block btn-primary btn-fill" onclick="window.location.href = '<?php echo $root; ?>teamAccount/create'">สร้างรายการใหม่</button>
								</div>
							</form>
						</div>
					</div>
								...
								if($lists != false){
									foreach($lists AS $value_team_account){
										$html_team_account .=	'<tr>
																<td>'.$value_team_account->name.'</td>
															';
										$html_team_account .=	'<td width="15%">
																<a href="'.$root.'teamAccount/edit/'.$value_team_account->id.'" class="btn btn-block btn-fill btn-warning">แก้ไข</a>
															</td>';
										$html_team_account .=	'<td width="15%">
																<form action="'.$root.'teamAccount/lists" method="post">
