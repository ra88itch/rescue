						...
						<div id="vehicle-<?php echo $vehicle_value->id;?>" class="panel-collapse collapse in">
							<div class="panel-body">
								<div class="col-xs-12 col-sm-3">
									...
									<input type="text" class="form-control" name="profile_vehicle[<?php echo $js_var->index_vehicle; ?>][detail][brand]" placeholder="Toyota/Isuzu/Nissan" value="<?php if(isset($v_detail)){ echo $v_detail->brand; } ?>">									
								</div>
