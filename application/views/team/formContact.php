							...
							<div class="panel-body">
								<div class="col-xs-12 col-sm-6">
									<div class="form-group">
										...
										if(isset($contact) && $contact->address->current_address != ''){ echo $contact->address->current_address ; }else{ echo '-'; } 
										?></textarea>
									</div>
								</div>
								<div class="col-xs-12 col-sm-6">
									<div class="form-group">
										...
										if(isset($contact) && $contact->address->address != ''){ echo $contact->address->address ; }else{ echo '-'; } 
										?></textarea>
									</div>
								</div>
							</div>
					...
					<div class="panel panel-default">
						...
						<div id="contact-insurance" class="panel-collapse collapse in">
							<div class="panel-body contact-insurance">
								...
								$html_insurance = '';
								if(isset($contact) && $contact->insurance != ''){
