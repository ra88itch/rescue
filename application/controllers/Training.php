...
class Training extends CI_Controller {
    ...
    function __construct() {
		...
		$this->current_location = 'training';
	...
	function lists($index = 1) {
		...
		$response['title'] = 'Training - '.$response['title'];
...
//		echo '</pre>';
	...
	function create(){
		...
		$response['current_location']	= $this->current_location;
		$response['title'] = 'Create Training Course - '.$response['title'];
	...
	function edit($team_account_id = false){
		...
		$response['current_location']	= $this->current_location;
		$response['title'] = 'Edit Training Course - '.$response['title'];
