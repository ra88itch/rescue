				...
				<div class="card">
					<div class="content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group">
									<label for="teamname">Username หรือ Email</label>
									<input type="text" class="form-control" name="teamname" placeholder="Teamname" value="<?php if(isset($post)){ echo $post['teamname']; } ?>">	
								</div>										
							</div>	
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-xs-12">							
								<div class="form-group">
									<button type="submit" class="btn btn-block btn-fill btn-primary" name="submit" value="login">ลงทะเบียน</button>
								</div>	
							</div>
						</div>
						</form>
